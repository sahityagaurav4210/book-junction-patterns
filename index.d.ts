...
/**
 * Interface defining forms-related related regex patterns.
 * Corresponds to patterns/forms.patterns.js
 */
export interface FormsRegex {
  /** Regular expression for validating single-line descriptions. */
  readonly description: RegExp;
  /** Regular expression for validating multi-line descriptions. */
  readonly multilineDescription: RegExp;
}
...
declare class Patterns {
  ...
  /**
   * A readonly object that contains forms related regex patterns
   * such as description and multiline description.
   * Usage:-
   * Patterns.forms.description.test("This is a sample description.") // true
   * Patterns.forms.multilineDescription.test("This is a sample\nmultiline description.") // true
   */
  static readonly forms: FormsRegex;
}
